...
Version: 1.0.0
Author: Home Loan Calculator / www.calculator.io
...
function display_calcio_ci_home_loan_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_home_loan_calculator', 'display_calcio_ci_home_loan_calculator' );